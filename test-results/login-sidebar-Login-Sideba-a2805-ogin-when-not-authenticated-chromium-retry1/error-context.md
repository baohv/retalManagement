...
- Name: login-sidebar.spec.ts >> Login + Sidebar >> redirects to login when not authenticated
- Location: tests/login-sidebar.spec.ts:84:7

# Error details

```
Error: page.goto: net::ERR_CONNECTION_REFUSED at http://localhost:3456/rooms
Call log:
  - navigating to "http://localhost:3456/rooms", waiting until "load"
